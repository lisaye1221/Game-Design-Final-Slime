...
function scr_confirmation_text(_text_id, _item, _this_machine){
	...
	switch(_text_id){
		...
		case "convert-wheat-to-jelly":
			scr_add_conf_text(string(item.conversion_rate) + " Wheat = 1 Slime Jelly");
			scr_add_conf_text("You own " + string(get_item_count(item)) + " wheat.");
		...
		case "convert-carrot-to-jelly":
			scr_add_conf_text(string(item.conversion_rate) + " Carrots = 1 Slime Jelly");
			scr_add_conf_text("You own " + string(get_item_count(item)) + " Carrots.");
			scr_add_conf_text("Continue?");
		...
		case "convert-cauliflower-to-jelly":
			...
			scr_add_conf_text("You own " + string(get_item_count(item)) + " Cauliflower.");
			scr_add_conf_text("Continue?");
